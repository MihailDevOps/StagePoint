  ...
  return (
    <Layout>
      ...
      <div className="justify-center items-center gap-5 flex mt-7">
        <Link href="/login" className="group px-5 py-2.5 bg-blue-600 rounded-3xl flex-col justify-center items-center inline-flex hover:border-blue-600 hover:bg-white text-white hover:text-blue-600 border transition ease-in-out duration-500">

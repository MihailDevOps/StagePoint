    ...
    return (
        <Layout >
            ...
            <div className='px-4 sm:px-20 flex flex-wrap justify-between text-black gap-5 mb-24'>
                {data.map(person =>
                    <div key={person.id} className='flex w-full lg:w-[49%] space-y-3 md:space-y-0 mt-10 flex-col md:flex-row space-x-5 items-center'>
                        <div className='rounded-full w-[250px] h-[250px]'>
                            <img src={`/images/people/${person.image}`} className='rounded-full w-[250px] h-[250px]' />
                        </div>
                        <div className='w-full md:w-[50%] font-normal text-base leading-[26.4px] space-y-2 max-h-[3290px]'>
                            ...
                            <p className='max-h-[140px] overflow-hidden'>{person.shortdescription.slice(0, 110)} ...</p>

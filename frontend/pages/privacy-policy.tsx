    ...
    return(
        <Layout>
            <div className="text-black w-full flex flex-col lg:flex-row">
                <div className='w-full lg:w-[40%] border-b lg:border-r border-black font-normal text-[64px] leading-19 uppercase pt-16 lg:pb-14 px-4 sm:px-20'>
                ...
                <div className='font-normal text-xl leading-[33px] w-full lg:w-[60%] pt-6 lg:pt-16 px-4 sm:px-20 space-y-10'>
            ...
            <div className='font-normal text-xl leading-[33px] w-full space-y-10 px-4 sm:px-20 py-10'>
